...
const OrganismsEditTaskScheduleDialog: React.FunctionComponent<IOrganismsEditTaskScheduleDialogProps> = ({taskItem}) => {
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button className="bg-warning mx-2"><FontAwesomeIcon icon={faPenToSquare}/></Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[1080px]">
                <DialogHeader>
                    <DialogTitle>Edit Scheduled Task / Event</DialogTitle>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input id="task_schedule_title" type="text" name="task_schedule_title" className="mb-4" defaultValue={taskItem.title}/>
                        <Label htmlFor="task_schedule_desc" className="mb-2">Description</Label>
                        <Textarea id="task_schedule_desc" name="task_schedule_desc" className="mb-4" defaultValue={taskItem.description}></Textarea>
                        ...
                        <MoleculesMultipleComboxBox context="Family Member" extraClass="mb-4" options={[
                            { title: "Jhon <b>(Dad)</b>", value:"1", checked: isInclude(taskItem.participant, "Jhon", 'nickname')},
                            { title: "You", value:"2", checked: isInclude(taskItem.participant, "You", 'nickname') },
                            { title: "Clarisa <b>(Mom)</b>", value:"3", checked: isInclude(taskItem.participant, "Clarisa", 'nickname') },
                            { title: "Bob <b>(Brother)</b>", value:"4", checked: isInclude(taskItem.participant, "Bob", 'nickname') },
                        ]}/>
                        ...
                        <MoleculesMultipleComboxBox context="Task Tags" extraClass="mb-4" options={
                            taskItem.tags ? sampleTags.map(tag => ({
                                ...tag, checked: isInclude(taskItem.tags ?? [], tag.value, 'value')
                            })) : sampleTags
                        }/>
                        ...
                        <div className="flex flex-wrap gap-2">
                            <div style={{minWidth:"200px"}}>
                                ...
                                <Select defaultValue={taskItem.taskDay}>
                            ...
                            <div>
                                ...
                                <Input id="task_schedule_hour_start" type="time" name="task_schedule_hour_start" className="mb-4" defaultValue={taskItem.startHour}/>
                            </div>
                            <div>
                                <Label htmlFor="task_schedule_hour_end" className="mb-2">Hour End</Label>
                                <Input id="task_schedule_hour_end" type="time" name="task_schedule_hour_end" className="mb-4" defaultValue={taskItem.endHour}/>
                            </div>
                        </div>
                    </div>
                    <div>
